...
/**
 * Created by Brett Blashko on 3/20/2015.
 */
public class Boundary_Square extends MapObject {
    ...
    public Boundary_Square(GameView gameView, Player player, double speed, int height,int  y, int x){
        super(gameView);
        ...
        paint_fill.setColor(Color.rgb(100, 0, 0));
    ...
    public void onDraw(Canvas canvas){
        ...
        }else if(oneTime && player.getShape() == 0){
            oneTime = false;
