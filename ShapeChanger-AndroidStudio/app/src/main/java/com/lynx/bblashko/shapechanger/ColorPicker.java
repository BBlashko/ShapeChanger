    ...
    private class ColorPickerView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            for (int x = 0; x < 256; x++) {
                ...
                canvas.drawLine(x + 10, 0, x + 10, 80, mPaint);
            ...
            for (int x = 0; x < 256; x++) {
                ...
                Shader shader = new LinearGradient(0, 50, 1, 306 + 256, colors, null,
                        Shader.TileMode.REPEAT);//0,50,0,306
                mPaint.setShader(shader);
                canvas.drawLine(x *2 + 10, 100, x *2 + 10 + 1, 356 + 256, mPaint);
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            setMeasuredDimension(276*2,366*2 );//276,366
