...
public class Hard_Game {
    ...
    public Hard_Game(GameView gameView, Player player, String [] colors){
        ...
        boundary_squares.add(new Boundary_Square(gameView, player, xSpeed, height / 3, 0,screenWidth + 3 * (screenWidth/4)));
        boundary_squares.add(new Boundary_Square(gameView, player, xSpeed, 2 * height /3, height + 200,screenWidth + 3 * (screenWidth/4)));
    }
    ...
    protected void determineNextBoundary(){
        ...
        boundary_squares.add(new Boundary_Square(gameView, player, xSpeed, height, 0, screenWidth + screenWidth/4));
        boundary_squares.add(new Boundary_Square(gameView, player, xSpeed, height2, height + 200, screenWidth + screenWidth/4));
